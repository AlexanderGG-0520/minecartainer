...
expected_common_suffix="install_modpack_dispatch install_c2me_jvm_args install_whitelist install_ops configure_c2me_opencl hook:post-install log:INFO:Install phase completed"
